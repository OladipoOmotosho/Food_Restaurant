...
const Transfer = () => {
  ...
  return (
    <>
      <div className="my-[48px] px-4">
        <div className="flex justify-center mb-[28px] sm:mb-[58px]">
          <CustomText
      ...
      <CustomModal show={showDetails}>
        <div
          ...
          className="px-[24px] md:px-[40px] pt-[40px] h-[678px] bg-white rounded-[15px] overflow-y-scroll max-w-[340px]"
        >
